...
class CompletedTodo extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return todos.isEmpty ? Center(
      child: Text(
        'No Completed Task',
        style: titletext(fsize:50 ,fontWeight: FontWeight.bold ),
      ),
    ):Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Padding(
          ...
          child: Center(child: Text('Completed Work list', style: titletext(color: Color(0xff1db954),fontWeight: FontWeight.w700)),),
        ),
        backgroundColor: Colors.grey[900],
      ),
      body: Container(
